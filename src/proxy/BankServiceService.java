 ...
 * 
 */
@WebServiceClient(name = "BankServiceService", targetNamespace = "http://sercice/", wsdlLocation = "http://localhost:8585/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICESERVICE_QNAME = new QName("http://sercice/", "BankServiceService");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://sercice/", "bankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sercice/", "bankServicePort"), BankService.class, features);
    }
